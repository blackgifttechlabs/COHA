...
import { BookOpen, Award, Users, ArrowRight, Monitor, Phone, Info, Mail, MapPin, Facebook, Instagram } from 'lucide-react';
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 sm:p-10 border-b-4 border-coha-900 hover:-translate-y-2 transition-transform duration-300">
